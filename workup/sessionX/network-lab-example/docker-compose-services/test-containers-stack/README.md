...
cd /home/ansible/devel/gitrepos/COM614-cloud-computing/sessions/sessionX/network-lab-example/docker-compose-services/ansible-semaphore-stack/ansible/aws/ansible-aws-example
...
```
curl -X POST http://localhost:3000/semaphore/semaphore/api/integrations/jk8qowte1qs7c1lo \
    -H 'semaphore-integration-command: stop-word-press-stack' \
    -H 'auth-match: minad1234' \
    -d '{
}'
```
